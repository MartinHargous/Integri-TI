...
(sudo crontab -u root -l 2>/dev/null | grep -v "ejecutar"; echo '@reboot sleep 15 && cd "/home/kali/Integri-TI/Client" && ./ejecutar.sh > cron_error.log 2>&1') | sudo crontab -u root -
