...
class ErrorDetection:
	...
	def install(self):
		...
		if MARKER_START in content:
			...
			return False
		path.write_text(content + "\n" + build_payload(self.log_path, self.config), encoding="utf-8")
	...
	def start_monitor(self):
		...
		print("[INFO] Notificaciones en vivo activadas.")
		return True
	...
	def run(self):
		...
		while True:
			...
			print(f"3. Iniciar notificaciones en vivo (Estado: {state})")
			print("4. Detener notificaciones en vivo")
			print("5. Salir")
